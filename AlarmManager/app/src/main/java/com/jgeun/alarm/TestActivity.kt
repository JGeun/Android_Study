...
import com.jgeun.alarm.databinding.ActivityTestBinding
import com.jgeun.alarm.model.AlarmDisplayModel
import java.util.*
...
//                alarmManager.setExactAndAllowWhileIdle()
    ...
    private fun renderView(model: AlarmDisplayModel) {
        ...
        println("model@@@@@@@@@@@")
        println("${model.ampmText} ${model.timeText}")
